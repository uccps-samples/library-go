...
const (
	...
	BuildJenkinsConsoleLogURLAnnotation = "uccp.io/jenkins-console-log-url"
	...
	BuildJenkinsBlueOceanLogURLAnnotation = "uccp.io/jenkins-blueocean-log-url"

	// BuildJenkinsBuildURIAnnotation is an annotation holding a link to the Jenkins build
	BuildJenkinsBuildURIAnnotation = "uccp.io/jenkins-build-uri"
	...
	BuildSourceSecretMatchURIAnnotationPrefix = "build.uccp.io/source-secret-match-uri-"
	...
	BuildConfigPausedAnnotation = "uccp.io/build-config.paused"
)
...
const (
	...
	BuildConfigLabel = "uccp.io/build-config.name"
