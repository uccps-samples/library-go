...
const (
	...
	// For example, uccp-kube-apiserver-encryption-3.  Note that other than the -3 postfix, the name of
	...
	EncryptionKeySecretsLabel = "encryption.apiserver.operator.uccp.io/component"
	...
	EncryptionSecretMigratedTimestamp = "encryption.apiserver.operator.uccp.io/migrated-timestamp"
	...
	EncryptionSecretMigratedResources = "encryption.apiserver.operator.uccp.io/migrated-resources"
	...
	encryptionSecretMode = "encryption.apiserver.operator.uccp.io/mode"
	...
	encryptionSecretInternalReason = "encryption.apiserver.operator.uccp.io/internal-reason"
	...
	encryptionSecretExternalReason = "encryption.apiserver.operator.uccp.io/external-reason"
	...
	EncryptionSecretKeyDataKey = "encryption.apiserver.operator.uccp.io-key"
	...
	EncryptionSecretFinalizer = "encryption.apiserver.operator.uccp.io/deletion-protection"
)

// MigratedGroupResources is the data structured stored in the
// encryption.apiserver.operator.uccp.io/migrated-resources
// of a key secret.
