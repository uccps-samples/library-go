...
pkg/operator/connectivitycheckcontroller/manifests/controlplane.operator.uccp.io_podnetworkconnectivitychecks.yaml: vendor/github.com/uccps-samples/api/operatorcontrolplane/v1alpha1/0000_10-pod-network-connectivity-check.crd.yaml
	mkdir -p $$(dirname $@)
	cp $< $@

update-bindata-podnetworkconnectivitychecks: pkg/operator/connectivitycheckcontroller/manifests/controlplane.operator.uccp.io_podnetworkconnectivitychecks.yaml

verify-bindata-podnetworkconnectivitychecks-manifests:
	diff -Naup pkg/operator/connectivitycheckcontroller/manifests/controlplane.operator.uccp.io_podnetworkconnectivitychecks.yaml vendor/github.com/uccps-samples/api/operatorcontrolplane/v1alpha1/0000_10-pod-network-connectivity-check.crd.yaml
